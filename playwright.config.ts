...
export default defineConfig({
  ...
  projects: [
    ...
    // API allows.
    { name: "console", testMatch: /console-responsive|console-item-paging|admin-responsive/, use: { ...devices["Desktop Chrome"], baseURL: "http://localhost:3100", launchOptions: { executablePath: chromium } } },
  ],
