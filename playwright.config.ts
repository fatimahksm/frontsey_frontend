...
export default defineConfig({
  ...
  projects: [
    ...
    // API allows.
    { name: "console", testMatch: /console-responsive|console-item-paging|console-sidebar|admin-responsive/, use: { ...devices["Desktop Chrome"], baseURL: "http://localhost:3100", launchOptions: { executablePath: chromium } } },
  ],
